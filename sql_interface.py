...
DEFAULT_TEXT_TO_SQL_TMPL = (
    "Given an input question, first create a syntactically correct {dialect} query to"
    " run, then look at the results of the query and return the answer. You can order"
    " the results by a relevant column to return the most interesting examples in the"
    " database.\n\nNever query for all the columns from a specific table, only ask for"
    " a few relevant columns given the question.\n\nPay attention to use only the"
    " column names that you can see in the schema description. Be careful to not query"
    " for columns that do not exist. Pay attention to which column is in which table."
    " Use wildcards to query for all posssible appearances of the specific device types"
    " names .Also, qualify column names with the table name when needed. You are"
    " required to use the following format, each taking one line:\n\nQuestion: Question"
...
rows = [
    {
        ...
        "product_name": "UR5e",
        "product_description": (
            "The UR5e is a lightweight and versatile cobot designed for industrial"
            " applications. It has a payload capacity of 5 kg and a reach of 850 mm."
            " The robot features 6 rotating joints and is programmed using a 12-inch"
            " touchscreen with a graphical user interface called PolyScope. It consumes"
            " less electricity compared to traditional industrial robots and offers"
            " increased uptime and productivity. The UR5e is agile and can be quickly"
            " deployed in existing manufacturing setups with limited space. It comes"
            " with built-in safety features and supports safe human-robot interaction."
            " The robot is part of the e-Series cobots and offers flexibility and ease"
            " of use for medium-duty applications."
        ),
        "payload": 5,
        "reach": 850,
        "degrees_of_freedom": 6,
        ...
        "axis_maximum_speed": "[180, 180, 180, 180, 180, 180]",
        "datasheet_source": (
            "['ur5e_user_manual_en_us_url1', 'ur5e_user_manual_en_us_pdf_00',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_0',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_00',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_01',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_02',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_03',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_04',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_05',"
            " 'ur5e_user_manual_en_us_pdf_sherpa_table_06']"
        ),
    },
    {
        ...
        "product_description": (
            "he Diana 7 industrial lightweight seven-axis robot is designed for complex"
            " and highly sensitive assembly processes. It has a payload capacity of"
            " seven kilograms and a functional reach of 923 mm. The robot is suitable"
            " for installing electronic components in smartphones, tablets, PCs, and"
            " more. It is being used in the Chinese market and is also being used in"
            " the automotive, pharmaceutical, and 3C production sectors. Agile Robots"
            " is currently producing Diana 7 in series production in China and plans to"
            " set up a production site in Bavaria. The robot offers safety through high"
            " precision torque-control and design, maximum dexterity in industrial"
            " environments, and intuitive teaching through a user-friendly interface."
        ),
        "payload": 7,
        "reach": 923,
        ...
        "datasheet_source": (
            "['diana7_pdf_00', 'diana7_pdf_01', 'diana7_pdf_02', 'diana7_pdf_03',"
            " 'diana7_pdf_sherpa_0', 'diana7_pdf_sherpa_table_00', 'diana7_pdf_00',"
            " 'diana7_pdf_01','diana7_pdf_02',]"
        ),
    },
]
...
query_str = (
    "Compare the technical characteristics two robots UR5e and Diana7. Answer with the"
    " table comparing data of this two robots."
)
RobotDB.make_query(query_str)
